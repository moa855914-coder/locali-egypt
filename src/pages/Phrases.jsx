...
const PHRASES = [
  ...
  { cat: 'emergency', en: 'I was robbed / scammed', arabic: 'اتسرق مني', phonetic: "Etssara' minni", tip: 'For reporting to Tourist Police.' },, arabic: 'اتسرق مني', phonetic: 'Etssara' minni', tip: 'For reporting to Tourist Police.' },
    ...
    <div className="px-4 py-6 max-w-3xl mx-auto">
      <div className="flex items-center gap-3 mb-4">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground">30 practical phrases that will genuinely help you in Egypt</p>
        </div>
      </div>
