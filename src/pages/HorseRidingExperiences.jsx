...
const SAMPLE_HORSES = [
  ...
  {
    id: 's2',
    title: 'Hurghada — Desert & Sea Horseback Adventure, Sahl Hasheesh (3 hrs)',
    city: 'hurghada',
    experience_type: 'beach_ride',
    price: 2430,
    price_type: 'per_person',
  ...
  {
    id: 's3',
    title: 'Hurghada — Swimming with Horses in the Red Sea, Makadi Bay (3 hrs)',
    city: 'hurghada',
  ...
  {
    id: 's4',
    title: 'Sharm El Sheikh — Sinai Desert Sunrise Ride, Nabq Area (2 hrs)',
    city: 'sharm-el-sheikh',
  ...
  {
    id: 's5',
    title: 'Hurghada — Sunset Horseback Ride on the Beach, El Dahar Coast (1.5 hrs)',
    city: 'hurghada',
    experience_type: 'sunrise_sunset_ride',
    price: 2150,
    price_type: 'per_person',
  ...
  {
    id: 's6',
    title: 'Dahab — Blue Lagoon Morning Beach Ride, Dahab South Sinai (1.5 hrs)',
    city: 'dahab',
    experience_type: 'beach_ride',
    price: 2000,
    price_type: 'per_person',
  ...
  {
    id: 's7',
    title: 'El Gouna — Lagoon & Beach Horse Ride, El Gouna Red Sea (2 hrs)',
    city: 'el-gouna',
    experience_type: 'beach_ride',
    price: 2430,
    price_type: 'per_person',
  ...
  {
    id: 's8',
    title: 'Aswan — Nubian Village Desert Ride, West Bank Aswan (2 hrs)',
    city: 'aswan',
