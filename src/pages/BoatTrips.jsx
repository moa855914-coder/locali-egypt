...
const SAMPLE_BOATS = [
  ...
  {
    id: 's3',
    boat_name: 'Royal Luxury VIP Cruise — Orange Bay (GetYourGuide Top Rated)',
    city: 'hurghada',
    boat_type: 'catamaran',
    price: 2800,
  ...
  {
    id: 's4',
    boat_name: 'Dolphin House Yacht — Swim with Wild Dolphins',
    city: 'hurghada',
    boat_type: 'yacht',
    price: 1850,
    price_type: 'per_person',
  ...
  {
    id: 's5',
    boat_name: 'Ras Mohamed Catamaran — Full Day Sharm (Viator top-rated)',
