...
const SAMPLE_BOATS = [
  {
    ...
    whatsapp: '201012345670',
    discount_code: 'LOCALI10',
    is_featured: true,
    status: 'approved',
    includes: 'Snorkeling gear, snacks, drinks, hotel transfer — NO hidden fees, NO cameraman',
  },
  {
    id: 's2',
    ...
    is_featured: true,
    status: 'approved',
    includes: 'Snorkeling & diving gear, snacks, drinks, hotel transfer',
  },
  {
    id: 's3',
    boat_name: 'Royal Luxury VIP Cruise — Orange Bay, Hurghada (GetYourGuide Top Rated)',
    city: 'hurghada',
    boat_type: 'catamaran',
    price: 2800,
    ...
    photos: ['https://source.unsplash.com/KOZxU5zLu6A/800x500'],
    whatsapp: '201112233445',
    discount_code: 'LOCALI10',
    is_featured: false,
    status: 'approved',
    includes: 'Snorkeling gear, buffet seafood lunch, soft drinks, hotel pickup',
  },
  {
    id: 's4',
    boat_name: 'Dolphin House Yacht — Swim with Wild Dolphins, Hurghada',
    city: 'hurghada',
    boat_type: 'yacht',
    price: 1850,
    price_type: 'per_person',
  ...
  {
    id: 's5',
    boat_name: 'Ras Mohamed Catamaran — Full Day, Sharm El Sheikh (Viator top-rated)',
  ...
  {
    id: 's6',
    boat_name: 'El Gouna Lagoon Speedboat Tour — El Gouna, Red Sea',
    city: 'el-gouna',
    boat_type: 'speedboat',
    price: 1800,
    price_type: 'per_person',
  ...
  {
    id: 's7',
    boat_name: 'Nubian Felucca — Nile Sunset Sail, Aswan Corniche',
    city: 'aswan',
    boat_type: 'sailboat',
    price: 900,
    price_type: 'per_hour',
    capacity: 8,
    duration_hours: 2,
    description: 'Authentic Nubian felucca sail between Elephantine Island, Kitchener\'s Island, and the West Bank at sunset. Tea, traditional Nubian music, knowledgeable guide. The most authentic Nile experience in Aswan.',
  ...
  {
    id: 's8',
    boat_name: 'Dahab Blue Hole Snorkel Boat — Dahab, South Sinai',
    city: 'dahab',
    boat_type: 'speedboat',
    price: 1200,
    price_type: 'per_trip',
