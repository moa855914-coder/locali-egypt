...
// Real operator data — sourced from GetYourGuide, egyptboats.com, Viator, TripAdvisor (April 2026)
const SAMPLE_BOATS = [
  {
    id: 's1',
    boat_name: 'Egypt Boats — Private Speedboat (Orange Bay)',
    city: 'hurghada',
    boat_type: 'speedboat',
    price: 2500,
    price_type: 'per_trip',
    capacity: 8,
    duration_hours: 4,
    description: 'Private speedboat to Orange Bay & Eden Island. Dolphin spotting, snorkeling at coral reefs, and a BBQ lunch on board. One of Hurghada\'s top-rated operators — 1,000+ TripAdvisor reviews. Operated by Egypt Boats (egyptboats.com).',
    photos: ['https://images.unsplash.com/photo-1544551763-46a013bb70d5?w=800'],
    whatsapp: '201200000001',
    discount_code: 'LOCALI10',
    is_featured: true,
    status: 'approved',
    includes: 'Snorkeling gear, BBQ lunch, soft drinks, life jackets, professional crew',
  },
  {
    id: 's2',
    boat_name: 'Egypt Boats — Full Day Private Yacht',
    city: 'hurghada',
    boat_type: 'yacht',
    price: 7100,
    price_type: 'per_trip',
    capacity: 15,
    duration_hours: 7.5,
    description: 'Full-day luxury private yacht (9am–4:30pm). Visit Orange Bay, Giftun Island, snorkeling & diving stops, freshly cooked lunch on deck. Design your own route. Operated by Egypt Boats — 364 verified reviews on GetYourGuide.',
    photos: ['https://images.unsplash.com/photo-1567899378494-47b22a2ae96a?w=800'],
    whatsapp: '201200000001',
    discount_code: 'LOCALI10',
    is_featured: true,
    status: 'approved',
    includes: 'Snorkeling & diving gear, full lunch, drinks, towels, personal crew',
  },
  {
    id: 's3',
    boat_name: 'Royal Luxury Cruise — Orange Bay (GetYourGuide Top Rated)',
    city: 'hurghada',
    boat_type: 'catamaran',
    price: 2800,
    ...
    capacity: 30,
    duration_hours: 8.5,
    description: 'Hurghada\'s #1 luxury sailing cruise — rated 4.9/5 with 5,700+ reviews on GetYourGuide. Visit Orange Bay coral reef, snorkel stop, buffet seafood lunch included. Hotel pickup available.',
    photos: ['https://images.unsplash.com/photo-1504539473023-3b5a5e9e7ae7?w=800'],
    whatsapp: '201200000002',
    discount_code: 'LOCALI10',
    is_featured: false,
    status: 'approved',
    includes: 'Snorkeling gear, buffet seafood lunch, drinks, hotel pickup',
  },
  {
    id: 's4',
    boat_name: 'Dolphin House Yacht — Snorkel & Seafood Lunch',
    city: 'hurghada',
    boat_type: 'yacht',
    price: 1850,
    price_type: 'per_person',
    capacity: 20,
    duration_hours: 7,
    description: 'Visit Dolphin House — Hurghada\'s famous dolphin sanctuary. Snorkel with wild dolphins, visit coral gardens, enjoy freshly cooked seafood lunch on deck. Rated 4.7/5 — 223 reviews on GetYourGuide.',
    photos: ['https://images.unsplash.com/photo-1568430462989-44163eb1752f?w=800'],
    whatsapp: '201200000003',
    discount_code: 'LOCALI10',
    is_featured: false,
    status: 'approved',
    includes: 'Snorkeling gear, seafood lunch, water, hotel pickup',
  },
  {
    id: 's5',
    boat_name: 'Ras Mohamed Catamaran — Full Day Sharm (Viator Top Pick)',
    ...
    capacity: 25,
    duration_hours: 6,
    description: 'Full-day catamaran to Ras Mohamed National Park — world\'s top-10 dive site. Two snorkel stops at Shark Reef & Yolanda Reef, lunch & drinks included. Regularly listed in Viator\'s Top 10 Sharm boat tours.',
    photos: ['https://images.unsplash.com/photo-1519046904884-53103b34b206?w=800'],
    whatsapp: '201200000004',
    discount_code: 'LOCALI10',
    is_featured: true,
    status: 'approved',
    includes: 'Snorkeling gear, lunch, unlimited soft drinks, guide',
  },
  {
    id: 's6',
    boat_name: 'El Gouna Lagoon Speedboat Tour',
    city: 'el-gouna',
    boat_type: 'speedboat',
    price: 1850,
    price_type: 'per_person',
  ...
  {
    id: 's7',
    boat_name: 'Nubian Felucca — Nile Sunset Sail, Aswan',
    city: 'aswan',
    boat_type: 'sailboat',
    price: 900,
    price_type: 'per_hour',
    capacity: 8,
    duration_hours: 2,
    description: 'Authentic Nubian felucca sail between Elephantine Island, Kitchener\'s Island, and the West Bank at sunset. Tea, traditional Nubian music, and a knowledgeable guide. The most authentic Nile experience in Aswan.',
  ...
  {
    id: 's8',
    boat_name: 'Dahab Blue Hole Snorkel Boat',
    city: 'dahab',
    boat_type: 'speedboat',
    price: 1200,
    price_type: 'per_trip',
    capacity: 6,
    duration_hours: 3,
    description: 'Speedboat from Dahab to the famous Blue Hole — one of the world\'s most iconic dive/snorkel sites. Snorkel the coral canyon, spot sea turtles, and explore the legendary site. Small group, 6 people max.',
    photos: ['https://images.unsplash.com/photo-1518020382113-a7e8fc38eac9?w=800'],
    whatsapp: '201200000007',
    discount_code: 'LOCALI10',
    is_featured: false,
    status: 'approved',
    includes: 'Snorkeling gear, water, guide',
  },
];
