            ...
            >
              ...
              <div className="flex-1">
                <p className="text-sm font-bold text-foreground">
                  {lang === 'ru' ? 'Спроси умного гида! 🇪🇬' : lang === 'de' ? 'Frag deinen smarten Guide! 🇪🇬' : lang === 'fr' ? 'Demandez à votre guide intelligent! 🇪🇬' : lang === 'it' ? 'Chiedi alla tua guida intelligente! 🇪🇬' : lang === 'es' ? '¡Pregunta a tu guía inteligente! 🇪🇬' : lang === 'zh' ? '询问您的智能导游！🇪🇬' : 'Ask your smart guide! 🇪🇬'}
                </p>
                <p className="text-xs text-muted-foreground mt-0.5">
                  {lang === 'ru' ? 'Рестораны, маршруты, цены, безопасность…' : lang === 'de' ? 'Restaurants, Routen, Preise, Sicherheit…' : lang === 'fr' ? 'Restaurants, prix, sécurité…' : lang === 'it' ? 'Ristoranti, prezzi, sicurezza…' : lang === 'es' ? 'Restaurantes, precios, seguridad…' : lang === 'zh' ? '餐厅、价格、安全…' : 'Restaurants, rides, prices, safety…'}
                </p>
              </div>
